...
- (NSArray *)subViewControllers
{
    ...
    store.tabBarItem = [self tabbarItemWithTitle:@"车票预订" andItemImage:@"travel"];
    ...
    cart.tabBarItem = [self tabbarItemWithTitle:@"我的行程" andItemImage:@"direction"];
    ...
    find.tabBarItem = [self tabbarItemWithTitle:@"旅行服务" andItemImage:@"commit"];
    ...
    mySelf.tabBarItem = [self tabbarItemWithTitle:@"个人中心" andItemImage:@"mySelf"];
