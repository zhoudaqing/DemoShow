...
- (NSArray *)subViewControllers
{
    ...
    store.tabBarItem = [self tabbarItemWithTitle:@"食谱" andItemImage:@"travel"];
    ...
    cart.tabBarItem = [self tabbarItemWithTitle:@"优食汇" andItemImage:@"direction"];
    ...
    find.tabBarItem = [self tabbarItemWithTitle:@"圈圈" andItemImage:@"commit"];
