...
- (NSArray *)subViewControllers
{
    ...
    store.tabBarItem = [self tabbarItemWithTitle:@"新闻动态" andItemImage:@"travel"];
    ...
    cart.tabBarItem = [self tabbarItemWithTitle:@"我的课程" andItemImage:@"direction"];
    ...
    find.tabBarItem = [self tabbarItemWithTitle:@"琴行介绍" andItemImage:@"commit"];
    ...
    mySelf.tabBarItem = [self tabbarItemWithTitle:@"更多" andItemImage:@"mySelf"];
